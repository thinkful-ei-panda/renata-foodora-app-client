  ...
  return (
    <section>
      <div>
        ...
        <h2>Do I need to be logged in to search?</h2>
        <p>
          "Login and Register are only made for restaurants. In order to use the
          app you don't need to have an account."
        </p>
        ...
        <p>
          "Yes. All you have to do is while you are logged in, click on your
          name up the top and click on Delete account. This will take you to a
          page to confirm you want to delete."
        </p>
      </div>
    </section>
  );
